...
const STREAK_MESSAGES: StreakMsg[] = [
  {
    ...
    body: "Triple digits. At this point you don't use Flint — Flint uses you.",
    emoji: "🏆",
  },
  {
    min: 75,
    title: "Unstoppable",
    body: "75 days. Scientists are studying you. They don't understand you either.",
    emoji: "🔬",
  },
  {
    min: 50,
    title: "50 Days?!",
    body: "Fifty days straight. Flint is basically your personality now. We're honored.",
    emoji: "🤯",
  },
  {
    min: 30,
    title: "One Month Strong",
    body: "A full month. Most people quit on day 3. You are not most people.",
    emoji: "💪",
  },
  {
    min: 21,
    title: "Habit Unlocked",
    body: "21 days — science says it's a habit now. Science also said Pluto was a planet, but still.",
    emoji: "🧠",
  },
  {
    min: 15,
    title: "Halfway to a Month",
    body: "15 days. You've built more momentum than a boulder rolling downhill. Do NOT stop.",
    emoji: "🪨",
  },
  {
    min: 10,
    title: "Double Digits",
    body: "10 days. You've outlasted most New Year's resolutions by about 355 days.",
    emoji: "🎯",
  },
  {
    min: 7,
    title: "One Full Week",
    body: "A whole week without breaking the chain. Your future self says thanks. Probably.",
    emoji: "📅",
  },
  {
    min: 5,
    title: "Five Days In",
    body: "Top 40% of people who said they'd be consistent. The bar is low. You're clearing it.",
    emoji: "✨",
  },
  {
    min: 3,
    title: "Hat Trick",
    body: "Three days. That's longer than most gym resolutions last. You're basically an athlete.",
    emoji: "🎩",
  },
  {
    min: 2,
    title: "Two Days Running",
    body: "Yesterday wasn't a fluke. Something is happening here. Don't overthink it.",
    emoji: "👀",
  },
  {
    min: 1,
    title: "Just Getting Started",
    body: "Day one. The hardest part was opening the app. You're practically done already.",
    emoji: "🌱",
  },
];
...
function getStreakMessage(streak: number): StreakMsg {
  return (
    STREAK_MESSAGES.find((m) => streak >= m.min) ?? STREAK_MESSAGES[STREAK_MESSAGES.length - 1]
  );
}
...
function QueueStack({ tasks }: { tasks: Task[] }) {
  ...
  return (
    <View style={styles.stackWrapper}>
      {showThird && <View style={styles.stackBack3} />}
      {showSecond && <View style={styles.stackBack2} />}
      <View style={styles.stackFront}>
        <View style={styles.stackLeft}>
          <Text style={styles.stackUpNext}>up next</Text>
          <Text style={styles.stackTitle} numberOfLines={1}>{next.title}</Text>
          {next.difficulty != null && (
            <Text style={styles.stackDifficulty}>
        ...
        <View style={styles.stackBadge}>
          ...
          <Text style={styles.stackBadgeLabel}>queued</Text>
        </View>
      </View>
    </View>
  );
...
export default function TasksScreen() {
  ...
  // Position popover below the badge, clamped to screen edges
  ...
  // Caret offset relative to popover
        ...
        {hasStreak && (
          <TouchableOpacity onPress={handleStreakPress} activeOpacity={0.75} hitSlop={8}>
            <View ref={badgeRef} style={styles.streakBadge}>
              <Flame size={15} color="#F97316" weight="fill" />
        ...
        {hasNoTasks ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyStateBody}>
              tap the{" "}
              <Text style={styles.emptyStateAccent}>+</Text>
      ...
      >
        ...
        <View style={[styles.popover, { top: popoverTop, left: popoverLeft }]}>
          ...
          <View style={styles.popoverFooter}>
            <Flame size={12} color="#F97316" weight="fill" />
